            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="panel">
                    <?php if (isset($_GET['msg'])) {
                        echo '<div class="alert alert-success">Signup success! You can now login with your details</div>';
                    } ?>
                    <h4>Sign in!</h4>
                    <hr/>
                    <?php if (!empty($error)): ?>
                    ...
                    <form class="form form-signIn" action="<?php echo site_url('signin'); ?>" method="post">
                        ...
                        <div class="clearfix">
                            ...
                            <a href="<?php echo site_url('create'); ?>" class="btn pull-right btn-forgot">Not
                                Registered?</a><br/>
                        </div>
                        <div class="clearfix">
